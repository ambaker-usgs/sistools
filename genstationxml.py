	...
	for blockette in dataless:
		...
		if isOpenStationEpoch:
			...
			if blockette.id == 52:
				...
				appendToFile(5, ['<fsx:Name>' + 'u' + '</fsx:Name>'])
				appendToFile(5, ['<fsx:Description>' + 'units' + '</fsx:Description>'])
				appendToFile(4, ['</fsx:CalibrationUnits>'])
			if blockette.id == 53:
				...
				appendToFile(7, ['<sis:ModelName>' + 'model name' + '</sis:ModelName>'])
				appendToFile(7, ['<sis:Category>' + 'category' + '</sis:Category>'])
				...
				appendToFile(7, ['<sis:Name>' + 'name' + '</sis:Name>'])
				appendToFile(7, ['<sis:SISNameSpace>' + sisinfo.agency() + '</sis:SISNameSpace>'])
				appendToFile(7, ['<sis:Type>' + 'type' + '</sis:Type>'])
				appendToFile(6, ['</sis:ResponseDictLink>'])
				appendToFile(5, ['</sis:Subresponse>'])
				appendToFile(4, ['</sis:Response>'])
				appendToFile(4, ['<sis:MeasurementType>' + 'measurement type' + '</sis:MeasurementType>'])
				appendToFile(4, ['<sis:SignalUnis>'])
				appendToFile(5, ['<sis:Name>' + 'u' + '</sis:Name>'])
				appendToFile(5, ['<sis:Description>' + 'units' + '</sis:Description>'])
